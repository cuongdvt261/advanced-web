...
namespace AdvancedWeb.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var products = db.Products.Include(p => p.Category).Include(p => p.Promotion);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Price,Quantity,Description,Image,CategoryId,CreatedDate,ModifiedDate,Deleted,TabIndex,PromotionId")] Product product)
        {
